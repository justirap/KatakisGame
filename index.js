...
class Pocisk {
    constructor(pozycja, przeskok, obrazek) {
        this.pozycja = pozycja;
        this.przeskok = przeskok;
...
class Meteoryt {
    constructor(pozycja, przeskok, warunek) {
        this.pozycja = pozycja;
        this.przeskok = przeskok;
        this.warunek = warunek;
        this.wybuch1 = "false";
...
class Kosmita {
    constructor(pozycja, przeskok, rodzaj, kulka) {
        this.pozycja = pozycja;
        this.przeskok = przeskok;
        this.warunek = "true";
        this.liczba = 0;
...
class Kulka {
    constructor(pozycja, przeskok, kolor) {
        this.kolor = kolor;
        this.pozycja = pozycja;
        this.przeskok = przeskok;
    }
...
class Statek {
    constructor(pozycja, przeskok, rodzaj) {
        this.pozycja = pozycja;
        this.przeskok = przeskok;
        this.liczba = 0;
        this.wybuch1 = "false";
...
canvas.height = 306;
canvas.id = "plansza";
(_a = document.getElementById("main")) === null || _a === void 0 ? void 0 : _a.appendChild(canvas);
...
window.addEventListener('keydown', function (event) {
    ...
    if (event.keyCode == 49) {
        if (wardotla == 0) {
            ...
            var tlo1 = document.getElementById("tloo");
...
function respawn() {
    ...
    var zm2 = 260;
    if (hp == 2) {
        var img = document.getElementById("dol");
        ;
    ...
    if (context != null) {
        ...
        bossy.forEach((meteoryt, index) => {
            if (meteoryt.pozycja[0] < -50) {
                ...
                main === null || main === void 0 ? void 0 : main.appendChild(napis);
            }
            else {
                meteoryt.odswiez();
                if (statekX + 76 >= meteoryt.pozycja[0] && statekX <= meteoryt.pozycja[0]) {
...
function Dopunktow() {
    ...
    div === null || div === void 0 ? void 0 : div.appendChild(img1);
    div === null || div === void 0 ? void 0 : div.appendChild(img2);
    div === null || div === void 0 ? void 0 : div.appendChild(img3);
    div === null || div === void 0 ? void 0 : div.appendChild(img4);
    div === null || div === void 0 ? void 0 : div.appendChild(img5);
    div === null || div === void 0 ? void 0 : div.appendChild(img6);
}
function sterowanie() {
    if (strzal == true) {
        if (Date.now() - czas > 200) {
            czas = Date.now();
            pociski.push(new Pocisk([statekX + 70, statekY + 15], [5, 0], "pocisk.png"));
            if (ulepszenie > 0) {
                pociski.push(new Pocisk([statekX + 40, statekY + 15], [2, 2], "pocisk1.png"));
                pociski.push(new Pocisk([statekX + 40, statekY + 15], [2, -2], "pocisk1.png"));
            }
        }
    }
